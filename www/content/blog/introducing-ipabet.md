...
With this in mind, I wondered if keyboard that somehow transformed two-letter combinations into IPA Unicode would solve the space issue. It gives us 676 (26²) slots for non-IPA letters. The creative, difficult part about this is figuring out what two letters correspond to each IPA letter. To create the mapping
