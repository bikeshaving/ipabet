...
const keysComponents = {
	...
	RulesTable: () => jsx`
		<${Table}>
			...
			<tr><td class="k">⇧X ⇧Y</td><td class="g">Æ Ŋ Ʃ Θ</td><td class="cp"></td><td>capital digraphs: capitalize the base, capitalize the result (⇧A⇧E → Æ, ⇧S⇧H → Ʃ, ⇧T⇧H → Θ) — every visually distinct capital forms; ASCII results and the Β/Χ lookalikes of B/X stay literal. All-caps words are Caps Lock's job</td></tr>
